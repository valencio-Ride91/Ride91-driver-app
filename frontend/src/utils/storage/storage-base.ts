...
// Anything JSON can round-trip, because that is exactly what the wrapper does:
// setItem JSON.stringifies and retrieve JSON.parses. Scalars alone were too
// narrow — the offline queue in src/sync.ts stores QueuedAction[].
