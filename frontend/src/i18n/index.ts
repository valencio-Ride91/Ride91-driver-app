...
const dict = {
  en: {
    ...
    retry: "Try again",
    go_to_charger: "Going to charger",
    charging_start: "Charging started",
    charging_stop: "Charging finished",
  ...
  hi: {
    ...
    go_to_charger: "चार्जर जा रहे हैं",
    charging_start: "चार्जिंग शुरू",
    charging_stop: "चार्जिंग पूरी",
  ...
  kn: {
    ...
    go_to_charger: "ಚಾರ್ಜರ್‌ಗೆ ಹೊರಟಿದ್ದೇನೆ",
    charging_start: "ಚಾರ್ಜಿಂಗ್ ಪ್ರಾರಂಭ",
    charging_stop: "ಚಾರ್ಜಿಂಗ್ ಮುಗಿದಿದೆ",
