...
// Phone + OTP only. Google sign-in was removed with the Emergent decoupling
// (it was brokered through Emergent's OAuth service). Fleet ops owns driver
// onboarding, so phone + OTP is the whole login.
        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          {stage === "phone" ? (
            ...
            <>
              ...
              <TouchableOpacity onPress={backToPhone} style={styles.textBtn}>
